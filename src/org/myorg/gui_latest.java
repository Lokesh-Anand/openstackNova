...
private JFrame mainFrame;
  ...
  public static void main(String[] args){
     gui_latest swingControlDemo = new gui_latest(); 
  ...
  private void showEventDemo(){
     ...
     okButton.setBounds(120, 0, 180, 20);
     ...
     okButton1.setBounds(120, 30, 180, 20);
     ...
     okButton2.setBounds(120, 60, 180, 20);
     ...
     okButton3.setBounds(120, 90, 180, 20);
...
dataValues[j][i] = tmp[i];   
    ...
    table.getColumn("Level").setCellRenderer(new Setcolor());
           ...
           if (result == JFileChooser.APPROVE_OPTION) {
            ...
            String arg[]={fname,"hdfs://localhost:54310/user/noutput/31"};
            String arg1[]={"hdfs://localhost:54310/user/noutput/31/part-r-00000","/home/hduser/sample/31/"};
            String arg2[]={"/home/hduser/sample/31/part-r-00000",fname};
            ...
            String columnNames[] = { "Request ID","Flow","Status","Details"};
               String dataValues[][]= new String[25][4];
               String line="";
              try{
           ...
           table.addMouseListener(new java.awt.event.MouseAdapter()
           {
               public void mouseClicked(java.awt.event.MouseEvent e)
               {
                ...
                frame1.setVisible(true);
                  ...
                  // l2.setForeground(Color.green);
                   frame1.getContentPane().add(new JScrollPane(l));
               ...
               JButton btn = new JButton("SEE RESOURCES USED");
               int a=btn.getX();
               int b=btn.getY();
               
               JButton btn1 = new JButton("SEE GRAPH OF TIMESTAMP");
               //btn1.setPreferredSize(new Dimension(30,5));
               btn1.setLocation(a,b-3);
               frame.getContentPane().add(btn,bdr.PAGE_END);
               frame.add(btn1,bdr.WEST);
